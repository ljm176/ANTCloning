...
def run(protocol):
        ...
        for i in range(0, nConstructs):
            p300Single.transfer(500, abayli.bottom(5), transformationPlate.wells()[i].bottom(5), new_tip="never")
        ...
        for i in list(range(0,nConstructs)):
            p20Single.transfer(5, gibson_rack.wells()[i], transformationPlate.wells()[i].bottom(5))
